...
import com.github.utils.ExcelWriteUtil;
...
public class ExcelUtils {
    ...
    /*      *) targetPath       =>      导出文件路径                                                              */
    /*      *) os               =>      导出文件流                                                                */
    public void exportObjects2Excel(List<?> data, Class clazz, boolean isWriteHeader, String sheetName, boolean isXSSF, HttpServletResponse response, String tableName) throws Exception {
        ExcelWriteUtil.write(response,exportExcelNoModuleHandler(data, clazz, isWriteHeader, sheetName, isXSSF),tableName);
    }
