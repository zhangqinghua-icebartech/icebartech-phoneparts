...
public class RSAUtil {
    ...
    public static Map<String, String> generateKeyPair() throws Exception {
        ...
        String retValue = new String(deBase64Value, CHAR_ENCODING);
    ...
    public static KeyStore getKsformPfx(String strPfx, String strPassword)
            throws Exception {
        @Cleanup FileInputStream fis = null;
        Security
    ...
    public static PublicKey getPubKeyFromCRT(String crtFileName) throws Exception {
        @Cleanup InputStream is = new FileInputStream(crtFileName);
    ...
    public static PublicKey getPublicKey(String key) throws Exception {
        X509EncodedKeySpec keySpec = new X509EncodedKeySpec(
                Base64.decodeBase64(key.getBytes(CHAR_ENCODING)));
    ...
    public static String sign(String content, String privateKey) {
        ...
        try {
            PKCS8EncodedKeySpec priPKCS8 = new PKCS8EncodedKeySpec(
                    Base64.decodeBase64(privateKey.getBytes(CHAR_ENCODING)));
            ...
            return new String(Base64.encodeBase64(signed), CHAR_ENCODING);
    ...
    public static String handleRSA(TreeMap<String, Object> map,
        ...
        if (StringUtils.isNotEmpty(privateKey)) {
            sign = RSAUtil.sign(signTemp, privateKey);
        }
        return sign;
    }
