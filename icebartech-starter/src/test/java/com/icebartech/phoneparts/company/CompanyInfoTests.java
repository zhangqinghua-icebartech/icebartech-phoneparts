package com.icebartech.phoneparts.company;
...
public class CompanyInfoTests {
    ...
    private final static String shiftUp = "/app/menu/shift_up";
    private final static String shiftDown = "/app/menu/shift_down";
