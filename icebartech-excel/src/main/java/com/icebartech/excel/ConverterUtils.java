...
class ConverterUtils {
    ...
    public static Integer toInt(Object obj, Integer defaultVal) {
        try {
            if (obj == null && defaultVal == null) return null;

            return obj == null ? defaultVal : (int) Double.parseDouble(toString(obj));
        } catch (Exception e) {
            e.printStackTrace();
        }
        return defaultVal;
    ...
    public static Long toLong(Object obj, long defaultVal) {
        return (obj != null) ? (long) Double.parseDouble(toString(obj)) : defaultVal;
    }
